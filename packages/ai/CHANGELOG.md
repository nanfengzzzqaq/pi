...
- Fixed local Qwen Chat Completions replay to preserve historical reasoning and send the selected reasoning effort alongside Qwen chat-template controls.
