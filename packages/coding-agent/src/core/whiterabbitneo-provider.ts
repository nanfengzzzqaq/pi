...
function whiteRabbitNeoConfig(env: WhiteRabbitNeoEnvironment): ProviderConfigInput {
...
/** Auto-register the user's local Ollama model only when its OpenAI-compatible endpoint is reachable. */
